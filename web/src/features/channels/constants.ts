...
import {
  CHANNEL_TYPE_LIBLIB as EXT_CHANNEL_TYPE_LIBLIB,
  CHANNEL_TYPE_RUNNING_HUB as EXT_CHANNEL_TYPE_RUNNING_HUB,
  CHANNEL_TYPE_RUNNING_HUB_INTL as EXT_CHANNEL_TYPE_RUNNING_HUB_INTL,
  EXT_CHANNEL_TYPES,
} from '@/extensions/channel-types'

export const CHANNEL_TYPE_NEW_API = 60
export const CHANNEL_TYPE_RUNNINGHUB = EXT_CHANNEL_TYPE_RUNNING_HUB
export const CHANNEL_TYPE_RUNNINGHUB_INTL = EXT_CHANNEL_TYPE_RUNNING_HUB_INTL
export const CHANNEL_TYPE_LIBLIB = EXT_CHANNEL_TYPE_LIBLIB
...
export const ERROR_MESSAGES = {
  ...
  INVALID_MAX_CONCURRENCY: 'Maximum concurrency must be between 0 and 100',
